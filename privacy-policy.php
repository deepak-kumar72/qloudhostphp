        ...
        <div class="row">
            <div class="col-md-6 d-flex align-item-center m-auto">
                <div class="hero-content">
                    <h3 class="hero-subTitle">FASTEST PERFORMANCE</h3>
                    <h1 class="mb-4">Privacy Policy</h1>
                    <p class="mb-4">Get your offshore VPS hosting now! Enjoy instant setup, untraceable footprints, and full data protection for your website. Stay anonymous and secure with our offshore servers, perfect for your privacy needs. Don’t wait—experience ultimate freedom and protection today!</p>
...
<div class="policies">
    ...
    <div class="content-sec mx-auto">
      ...
      <p>
        ...
        contact our team at <a href='' class="faq-link"> support@qloudhost.com</a> and find a solution regarding
        its concerns.
      </p>
      </div>
      </div>
