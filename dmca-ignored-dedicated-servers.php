<?php
$page = 'dmca-ignored-dedicated-servers';
...
<div class="container my-5 qloudService-section">
    <h2 class="text-center mb-3 m-auto">Why Choose QloudHost DMCA Ignored Server?</h2>
...
<?php
include('./inc/dedicatedHostingSolution.php');
?>
                    ...
                    <div class="accordion-item faq-items">
                        <h2 class="accordion-header" id="flush-headingTwo">
                            <button class="accordion-button acc-purple-bg collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I upgrade my VPS to an DMCA Ignored dedicated servers?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item faq-items">
                        <h2 class="accordion-header" id="flush-headingseven">
                            <button class="accordion-button acc-purple-bg collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How do I get started with DMCA Ignored dedicated server?

                            </button>
                        </h2>
                        <div id="flush-collapseseven" class="accordion-collapse collapse" aria-labelledby="flush-headingseven"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">To get started with our DMCA Server, you just need to choose your favourite reliable offshore web hosting plan, enter your authentic details and checkout! Your servers will be ready to use in just a few days, all thanks to our instant activation policy.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-items">
                        <h2 class="accordion-header" id="flush-headingseven1">
                            <button class="accordion-button acc-purple-bg collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Does QloudHost provide managed DMCA Ignored dedicated servers?

                            </button>
                        </h2>
                        <div id="flush-collapseseven1" class="accordion-collapse collapse" aria-labelledby="flush-headingseven1"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">On account of providing full flexibility and root access with our cheap dmca dedicated server hosting solution, we don’t provide Fully managed dedicated servers. Hence, you completely customise your servers as per your needs and requirements.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-items">
                        <h2 class="accordion-header" id="flush-headingseven2">
                            <button class="accordion-button acc-purple-bg collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How long will it take for my cheap DMCA Ignored dedicated server to be ready?

                            </button>
                        </h2>
                        <div id="flush-collapseseven2" class="accordion-collapse collapse" aria-labelledby="flush-headingseven2"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">As explained above in the above FAQ, we offer our services to the market with an instant activation policy. Hence, after you finished the payment, your DMCA Ignored hosting services will be ready to use in 5-7 Working days.</div>
                        </div>
                    </div>
                </div>
            </div>
