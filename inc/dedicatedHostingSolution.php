<div class='service-section'>
      <div class="container py-5">
        <h2 class="text-center text-white mb-3 m-auto w-100">For Whom Offshore Dedicated Web Hosting Solutions?</h2>
        <p class="text-center text-white mb-5 planHead-con m-auto">
