...
$meta_data = [
    'Home' => [
        ...
        'description' => "QloudHost ❤ Offer Best DMCA Ignored Hosting Servers at Reasonable Prices to Accelerate Online Growth With 100% Privacy Protection Guaranteed and 24/7 Support.",
        'keywords' => "",
        'schema' => '
  ...
  'ffmpeg-hosting' => [
      ...
      'keywords' => "FFmpeg hosting, web hosting with FFmpeg, FFmpeg hosting unlimited, FFmpeg web hosting, hosting with FFmpeg, FFmpeg VPS Hosting, FFmpeg Dedicated Server ",
      'schema' => '<script type="application/ld+json">
      "@context": "https://schema.org",
        "@type": "Product",
        "name": "FFMPEG Hosting",
