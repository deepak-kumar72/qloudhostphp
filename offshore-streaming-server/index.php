        ...
        <div class="row">
            ...
            <div class="col-md-6 m-auto">
                <div class="hero-image-container position-relative text-end w-100 h-100">
                    <img src="../assets/img/Frame/robust-offshore-streaming-server.webp" alt="Robust offshore Streaming Server" class="hero-frame h-100 w-100" />
            ...
            <div key={plan.id} class="col-12 col-md-6 col-lg-6 explore-plan-col">
                <div class="card-body offshore-plan-body position-relative h-100">
                    <div>
                        ...
                        <a href={plan.url} class='dedicated-plan-btn'>
                        <button class="plan-btn dedicated-plan-btn d-flex justify-content-between mb-4 mt-5">
                            Buy Now
                            <i class="ms-3 start-now-icon fa-solid fa-arrow-right"></i> 
                        </button></a>
                        <h4 class='mb-3 top-feature'>Top Features</h4>
    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-md-6 mb-4 text-center">
                <img
                    src='../assets/img/feature/fast-and-reliable.webp'
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6 order-md-2 mb-3 text-center">
                <img src='../assets/img/feature/at-qloudhost.webp' alt="At QloudHost, Quality Matters" class="img-fluid" />
            </div>
    ...
    <div class="row mt-4 justify-content-center">
        <div class="col-12 col-md-6 col-lg-4 mb-4">
            <div class="card service-card-body">
                <div class="p-3">
                    <img src="../assets/img/serviceImg/secure-offshore-location.svg" alt="secure-offshore-location" class="mb-3 qloudService-img" />
